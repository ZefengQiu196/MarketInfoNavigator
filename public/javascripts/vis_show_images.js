...
/**
 * Defines three views to show images and papers
 * Figure view: presentImg()
 * Paper card view: presentPaperCards()
 * Paper view: presentUPPapers()
 */
...
function presentImg(imgData, showAnnotation, sortedKey = 0, imgSize = 1, currentPage) {
    ...
    var category_info = document.getElementById("category-info"); 
    var label_info = document.getElementById("label-info"); 
    var state_info = document.getElementById("state-info"); 
    var thc_info = document.getElementById("thc-info"); 
    var cbd_info = document.getElementById("cbd-info"); 
    ...
    $('.image-a').click(function(e) {
        ...
        if (document.getElementById("year-info")) {
        ...
        if (category_info) {
            category_info.innerHTML = imgData[id]['Category']; 
        }
        if (label_info) {
            label_info.innerHTML = imgData[id]['Label']; 
        }
        if (thc_info) {
            thc_info.innerHTML = imgData[id]['THC']; 
        }
        if (cbd_info) {
            cbd_info.innerHTML = imgData[id]['CBD']; 
        }
        if (state_info) {
            state_info.innerHTML = imgData[id]['State']; 
        }
...
//                 <!-- The code is auto-generated by https://sharingbuttons.io/ -->
