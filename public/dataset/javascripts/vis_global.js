...
async function dbStart() {
    ...
    G_IMG_DATA = await d3.csv("public/dataset/vispubData_updated.csv");
    // console.log("load", G_IMG_DATA.length, "data");
    // G_IMG_DATA.forEach((d) => {
    //     if (!d.Category) {
    //         d.Category = "Unknown"; 
    //     }
    // });
    ...
    // const csvFiles = [
    //     "public/dataset/vispub_part_a.csv",
    //     "public/dataset/vispub_part_b.csv",
    //     "public/dataset/vispub_part_c.csv"
    // ];
    ...
    //     G_IMG_DATA = G_IMG_DATA.concat(data);
    // }
